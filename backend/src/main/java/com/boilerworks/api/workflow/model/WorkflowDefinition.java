...
/**
 * Defines a workflow state machine. Schema format: { "states": ["draft", "review", "approved",
 * "rejected"], "initial": "draft", "terminal": ["approved", "rejected"], "transitions": [ { "name":
 * "submit", "from": "draft", "to": "review", "requiredPermission": "workflow.submit" }, { "name":
 * "approve", "from": "review", "to": "approved", "requiredPermission": "workflow.approve" }, {
