...
/**
 * Validates form submission data against a form definition schema. Schema format: { "fields": [ {
 * "name": "field_name", "type": "text|number|email|select|checkbox|textarea|date", "label": "Field
 * Label", "required": true/false, "options": [...], "min": ..., "max": ..., "pattern": "..." } ] }
 */
@Service
